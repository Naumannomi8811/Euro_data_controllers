                  ...
                  <table class="table">
                    ...
                    <tbody class="table-tbody">
                      ...
                      <tr>
                        ...
                        <td class="sort-type"><?php echo $urow['address']; ?></td>
                        <td class="sort-score">
                          <div class="btn-list flex-nowrap justify-content-center">
                              <a href="user_profile.php?user_id=<?php echo $urow['user_id']; ?>" class="btn">
                                View
                              </a>
                              <div class="dropdown">
                                <!-- <button class="btn dropdown-toggle align-text-top" data-bs-toggle="dropdown"> -->
                                <a href="delete-user.php?user_id=<?php echo $urow['user_id']; ?>" class="btn  align-text-top">
                                  Delete
                                </a>
