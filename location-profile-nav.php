            ...
            <div class="row align-items-center">
              <div class="col-auto">
				  <?php
					if($srow['site_pic']){
					?>
					<img src="media/avatars/<?php echo $srow['site_pic']; ?>" alt="image" style="border-radius: 8px; width: 120px;"/>	
							
					<?php
					}else{
						?>
						<img src="media/avatars/location.jpg" alt="image" style="border-radius: 8px; width: 120px;"/>
					<?php	
					}
				  ?>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                      <li class="nav-item">
                        <a href="#tabs-profile" class="nav-link active" data-bs-toggle="tab">Location Overview</a>
                      </li>
                      <li class="nav-item">
                        <a href="#tabs-setting" class="nav-link" data-bs-toggle="tab">Location Settings</a>
                      </li>
                    </ul>
                  </div>
                  <!-- ***************End Header******************* -->